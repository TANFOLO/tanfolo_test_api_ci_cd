...
public class ClientSpecificationsBuilder extends ParentSpecificationsBuilder {
	...
	public ClientSpecificationsBuilder with(String key, String operation, Object value, boolean orPredicate) {
