...
public class ActionAuditSpecification implements Specification<ActionAudit> {
	
	/*
	 * Logger de la classe
	 */
	private static Logger logger = LogManager.getLogger(ActionAuditSpecification.class);  
	...
	public ActionAuditSpecification(SearchCriteria criteria) {
		super();
