...
public class EditOperationParams extends ParentParams {
	...
	@ApiModelProperty(notes = "Client qui demande l'opération (si le client avait déjà un compte)", allowEmptyValue = true, required = false)
	...
	//@NotNull(message = "{err.operation.create.arrivee.date_prevue}")
	...
	@ApiModelProperty(notes = "Tonnage de véhicule saisies par le client", allowEmptyValue = false, required = true)
