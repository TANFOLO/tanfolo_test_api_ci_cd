...
public class EditClientPersonnelParams extends ParentParams {
	...
	@ApiModelProperty(notes = "Langue du responsable de l'expéditeur (pas de modification si non renseigné)", allowEmptyValue = true, required = false)
	//@NotNull(message = "{err.user.create.locale}")
	protected String locale;

	@ApiModelProperty(notes = "Code pays du responsable de l'expéditeur (pas de modification si non renseigné)", allowEmptyValue = true, required = false)
	...
	@ApiModelProperty(notes = "Mot de passe pour se connecter à la webapp expéditeur", allowEmptyValue = true, required = false)
