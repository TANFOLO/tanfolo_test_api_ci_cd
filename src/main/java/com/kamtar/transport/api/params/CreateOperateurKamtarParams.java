...
public class CreateOperateurKamtarParams extends ParentParams {
	...
	@ApiModelProperty(notes = "Mot de passe de l'opérateur", allowEmptyValue = false, required = true)
	...
	@NotNull(message = "{err.user.create.liste_droit}")
	...
	public CreateOperateurKamtarParams() {
		super();
	}
