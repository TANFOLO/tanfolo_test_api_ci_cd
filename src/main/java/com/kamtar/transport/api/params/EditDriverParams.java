...
public class EditDriverParams extends ParentParams {
	...
	//@NotNull(message = "{err.user.create.permis_numero}")
	//@Size(min = 1, max = 100, message = "{err.user.create.permis_numero_longueur}")
